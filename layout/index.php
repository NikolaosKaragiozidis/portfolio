    ...
    <div class="header-container">
        <div class="header-item logo">
            <div class="logo-container">
                <img src="../images/nkarag_logo.png" alt="nikos karag logo" />
            </div>
        </div>
        ...
        <div class="header-item hamburger-nav">
            <div class="hamburger-icon">
                <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>hamburger</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill-rule="evenodd"> <g id="Icon-Set-Filled"  transform="translate(-212.000000, -888.000000)"> <path d="M230,904 L214,904 C212.896,904 212,904.896 212,906 C212,907.104 212.896,908 214,908 L230,908 C231.104,908 232,907.104 232,906 C232,904.896 231.104,904 230,904 L230,904 Z M230,896 L214,896 C212.896,896 212,896.896 212,898 C212,899.104 212.896,900 214,900 L230,900 C231.104,900 232,899.104 232,898 C232,896.896 231.104,896 230,896 L230,896 Z M214,892 L230,892 C231.104,892 232,891.104 232,890 C232,888.896 231.104,888 230,888 L214,888 C212.896,888 212,888.896 212,890 C212,891.104 212.896,892 214,892 L214,892 Z" id="hamburger"> </path> </g> </g> </g></svg>
            </div>
...
<main>
    <div class="main-container">
        <section class="main left-outer">
            <div class="main left-inner"></div>
        </section>
        <section class="main right-outer">
                <div class="main right-inner">
                    <div class="main-fullname-container">
                        <h1 class="main-header-name">NIKOLAOS</h1>
                        <h1 class="main-header-surname">KARAGIOZIDIS</h1>
                    </div>
    ...
    <section class="main box-grid-outer">
        ...
        <div class="box-grid-inner">
            ...
            <div class="box box-2">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti odit saepe tempora.</p>
            </div>
            <div class="box box-3">
                <div class="box-header-icon">
                    <h3>test</h3>
